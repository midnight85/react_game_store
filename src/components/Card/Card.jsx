...
export default function Card({id, name, imgPath, price}) {

    const {cartGames, addGameToCart, removeGameFromCart} = useContext(AppContext)
    const [isCartAdded, setIsCartAdded] = useState()
    const addClickHandle = () => {
        isCartAdded ?
            removeGameFromCart({id, name, imgPath, price})
            : addGameToCart({id, name, imgPath, price})
    }
    useEffect(()=>{
