...
export default function Card({id, name, imgPath, price, onClickAdd }) {

    const [cartAdded, setCartAdded] = useState(false)

    const addClickHandle = () => {
        setCartAdded(!cartAdded)
        onClickAdd({ id, name, imgPath, price }, cartAdded)
    }
            ...
            <div className="card__body">
                ...
                <div className="card__actions">
                    ...
                    <button className="card__addBtn"
                        ...
                        style={cartAdded ? { backgroundColor: '#7cd97f' } : { backgroundColor: '#fff' }}
                    >
                        {cartAdded ? <CheckIcon /> : <AddIcon />}
